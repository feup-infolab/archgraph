...
::
  ...
  PyObject *
  PyArray_GetField(PyArrayObject *cls, PyArray_Descr *typed, int
                   offset)
...
::
  ...
  int
  PyArray_SetField(PyArrayObject *cls, PyArray_Descr *dtype, int
                   offset, PyObject *val)
...
::
  ...
  PyObject *
  PyArray_Byteswap(PyArrayObject *cls, npy_bool inplace)


::

  PyObject *
  PyArray_Resize(PyArrayObject *cls, PyArray_Dims *newshape, int
...
::
  ...
  PyObject *
  PyArray_ToList(PyArrayObject *cls)
...
::
  ...
  PyObject *
  PyArray_ToString(PyArrayObject *cls, NPY_ORDER order)


::

  int
  PyArray_ToFile(PyArrayObject *cls, FILE *fp, char *sep, char *format)
...
::
  ...
  int
  PyArray_Dump(PyObject *cls, PyObject *file, int protocol)


::

  PyObject *
  PyArray_Dumps(PyObject *cls, int protocol)
...
::
  ...
  PyArray_Descr *
  PyArray_DescrNewByteorder(PyArray_Descr *cls, char newendian)
...
Leaves reference count of cls unchanged --- does not DECREF cls ***
...
::
  ...
  PyObject *
  PyArray_PutTo(PyArrayObject *cls, PyObject*values0, PyObject
...
::
  ...
  PyObject *
  PyArray_PutMask(PyArrayObject *cls, PyObject*values0, PyObject*mask0)
...
::
  ...
  PyObject *
  PyArray_Reshape(PyArrayObject *cls, PyObject *shape)
...
::
  ...
  PyObject *
  PyArray_Newshape(PyArrayObject *cls, PyArray_Dims *newdims, NPY_ORDER
                   order)
...
::
  ...
  PyObject *
  PyArray_Squeeze(PyArrayObject *cls)
...
::
  ...
  PyObject *
  PyArray_View(PyArrayObject *cls, PyArray_Descr *type, PyTypeObject
               *pytype)
...
::
  ...
  PyObject *
  PyArray_Mean(PyArrayObject *cls, int axis, int rtype, PyArrayObject
               *out)
...
::
  ...
  PyObject *
  PyArray_Trace(PyArrayObject *cls, int offset, int axis1, int
...
::
  ...
  PyObject *
  PyArray_Diagonal(PyArrayObject *cls, int offset, int axis1, int
                   axis2)
...
onto 'cls', but it still copies this array before returning, as well as
setting the internal WARN_ON_WRITE flag. In a future version, it will
simply return a view onto cls.

::

  PyObject *
  PyArray_Clip(PyArrayObject *cls, PyObject *min, PyObject
...
::
  ...
  PyObject *
  PyArray_Conjugate(PyArrayObject *cls, PyArrayObject *out)
...
::
  ...
  PyObject *
  PyArray_Nonzero(PyArrayObject *cls)
...
::
  ...
  PyObject *
  PyArray_Std(PyArrayObject *cls, int axis, int rtype, PyArrayObject
              *out, int variance)
...
::
  ...
  PyObject *
  PyArray_Sum(PyArrayObject *cls, int axis, int rtype, PyArrayObject
              *out)
...
::
  ...
  PyObject *
  PyArray_CumSum(PyArrayObject *cls, int axis, int rtype, PyArrayObject
                 *out)
...
::
  ...
  PyObject *
  PyArray_Prod(PyArrayObject *cls, int axis, int rtype, PyArrayObject
               *out)
...
::
  ...
  PyObject *
  PyArray_CumProd(PyArrayObject *cls, int axis, int
...
::
  ...
  PyObject *
  PyArray_All(PyArrayObject *cls, int axis, PyArrayObject *out)
...
::
  ...
  PyObject *
  PyArray_Any(PyArrayObject *cls, int axis, PyArrayObject *out)
...
::
  ...
  PyObject *
  PyArray_Compress(PyArrayObject *cls, PyObject *condition, int
...
::
  ...
  npy_intp
  PyArray_CountNonzero(PyArrayObject *cls)
...
::
  ...
  int
  PyArray_ResolveWritebackIfCopy(PyArrayObject *cls)


If WRITEBACKIFCOPY and cls has data, reset the base WRITEABLE flag,
