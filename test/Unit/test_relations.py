...
from src.Models.ArchOnto.v0_1.NodeEntities.ARE5_Identifier_Type import ARE5_Identifier_Type
...
from src.Models.CRM.v5_0_2.NodeEntities.E42_Identifier import E42_Identifier
...
class TestNeoModel(unittest.TestCase):
    ...
    def test_eva(self):
        registo = String(stringValue="Registo de Batismo", name="registo").save()
        formal_title = ARE2_Formal_Title(name="Formal Title").save()
        monument = E24_Physical_Human_Made_Thing(name="monument").save()

        identifier = E42_Identifier(name="E42_Identifier").save()
        identifier_value = String(stringValue="PT/ADPRT", name="identifier").save()
        codigo = String(stringValue="Codigo De Referencia", name="codigo").save()
        identifier_type = ARE5_Identifier_Type(name="identifier_type").save()

        formal_title.has_value.connect(registo)
        monument.P102_has_title.connect(formal_title)
        monument.P1_is_identified_by.connect(identifier)
        monument.P2_has_type.connect(identifier_type)
