...
from ..NodeProperties.P177_assigned_property_type import \
...
class E55_Type(E28_Conceptual_Object):
    ...
    assigned = RelationshipFrom(
        ".E17_Type_Assignment.E17_Type_Assignment", "P42_assigned", model=P42_assigned
    )
    had_as_general_use = RelationshipFrom(
        ".E70_Thing.E70_Thing", "P101_had_as_general_use", model=P101_had_as_general_use
    )
    ...
    exemplifies = RelationshipFrom(
        ".E1_CRM_Entity.E1_CRM_Entity", "P137_exemplifies", model=P137_exemplifies
    )
