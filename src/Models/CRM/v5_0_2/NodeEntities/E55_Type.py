...
from .E28_Conceptual_Object import E28_Conceptual_Object
...
class E55_TypeSchema(Schema):
    P127_has_broader_term = fields.List(fields.Nested("src.Models.CRM.v5_0_2.NodeEntities.E55_Type.E55_TypeSchema", exclude=("P127_has_broader_term",)))
    P150_defines_typical_parts_of = fields.List(fields.Nested("src.Models.CRM.v5_0_2.NodeEntities.E55_Type.E55_TypeSchema", exclude=("P150_defines_typical_parts_of",)))
