...
from src.Models.CRM.v5_0_2.NodeEntities.E97_Monetary_Amount import E97_Monetary_AmountSchema
...
class E95_PurchaseSchema(E8_AcquisitionSchema):
    had_sales_price = fields.List(fields.Nested(E97_Monetary_AmountSchema)
    )
