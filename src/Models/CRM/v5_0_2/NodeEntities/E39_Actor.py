...
from src.Models.CRM.v5_0_2.NodeProperties.P11_had_participat import \
    P11_had_participant
from src.Models.CRM.v5_0_2.NodeProperties.P14_carried_out_by import \
    P14_carried_out_by
...
class E39_Actor(E77_Persistent_Item):
    ...
    joined = RelationshipFrom(
        ".E85_Joining.E85_Joining", "P143_joined", model=P143_joined
    )
    separated = RelationshipFrom(
        ".E86_Leaving.E86_Leaving", "P145_separated_from", model=P145_separated
    )
