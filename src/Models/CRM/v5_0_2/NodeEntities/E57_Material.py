...
from src.Models.CRM.v5_0_2.NodeProperties.P45_consists_of import \
    P45_consists_of
from src.Models.CRM.v5_0_2.NodeProperties.P68_foresees_use_of import \
    P68_foresees_use_of
...
class E57_Material(E55_Type):
    ...
    employed = RelationshipFrom(
        ".E11_Modification.E11_Modification", "P126_employed", model=P126_employed
    )
    at = RelationshipFrom(".E93_Presence.E93_Presence", "P167_at", model=P167_at)
