...
from src.Models.CRM.v5_0_2.NodeProperties.P123_resulted_in import \
    P123_resulted_in
...
class E18_Physical_Thing(E72_Legal_Object):
    ...
    has_modified = RelationshipFrom(
        ".E11_Modification.E11_Modification", "P31_has_modified", model=P31_has_modified
    )
    ...
    added = RelationshipFrom(
        ".E79_Part_Addition.E79_Part_Addition", "P111_added", model=P111_added
    )
    removed = RelationshipFrom(
        ".E80_Part_Removal.E80_Part_Removal", "P113_removed", model=P113_removed
    )
