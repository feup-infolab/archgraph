...
class E74_Group(E39_Actor):
    has_formed = RelationshipFrom(
        ".E66_Formation.E66_Formation", "P95_has_formed", model=P95_has_formed
    )
    dissolved = RelationshipFrom(
        ".E68_Dissolution.E68_Dissolution", "P99_dissolved", model=P99_dissolved
    )
    joined_with = RelationshipFrom(
        ".E85_Joining.E85_Joining", "P144_joined_with", model=P144_joined_with
    )
    separated_from = RelationshipFrom(
        ".E86_Leaving.E86_Leaving", "P146_separated_from", model=P146_separated_from
    )
    was_formed_from = RelationshipFrom(
        ".E66_Formation.E66_Formation",
        "P151_was_formed_from",
        model=P151_was_formed_from,
    )
