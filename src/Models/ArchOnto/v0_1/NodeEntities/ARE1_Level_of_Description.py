...
from src.Models.ArchOnto.v0_1.NodeProperties.ARP12_has_level_of_description import ARP12_has_level_of_description
...
class ARE1_Level_of_Description(E55_Type):
    upper_level = RelationshipFrom(
        ".ARE1_Level_of_Description.ARE1_Level_of_Description", "ARP8_upper_level", model=ARP8_upper_level
    )
